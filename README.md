...
- User Login Credentials: (user/user)
...
insert into users values('user','user','user','user','user','1236547089','tarunmadamanchi@gmail.com',2);
...
Step 1.: Go inside ```src/main/resources > application.properties``` and update the value of database details as per your usage, like db.driver, db.host, db.username and db.password according to your installed mysql/postgresql admin user credentials.
...
Step 8: The default Username And Password For User Is "user" And "user"
